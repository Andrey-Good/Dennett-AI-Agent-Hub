...
class TestHuggingFaceService:
    ...
    def service(self, mock_hf_api, mock_aiohttp_session):
        ...
        with (
            patch(
                "ai_core.core.services.huggingface_service.HfApi",
                return_value=mock_hf_api,
            ),
            patch(
                "ai_core.core.services.huggingface_service.aiohttp.ClientSession",
...
```"""
    ...
    def test_service_initialization(self):
        ...
        with patch("ai_core.core.services.huggingface_service.HfApi"):
            service = HuggingFaceService()
    ...
    async def test_service_async_context_manager(self):
        ...
        with (
            patch("ai_core.core.services.huggingface_service.HfApi"),
            patch(
                "ai_core.core.services.huggingface_service.aiohttp.ClientSession",
