...
class ModelManagerConfig(BaseSettings):
    ...
    # API Settings
    api_token: str = Field(default="your-secure-api-token", alias="MODEL_MANAGER_API_TOKEN")
    api_host: str = Field(default="0.0.0.0", alias="API_HOST")
    api_port: int = Field(default=8000, alias="API_PORT")
    
    # Storage Settings - теперь в AppData
    models_dir: str = Field(default=str(APP_DATA_DIR / "models"), alias="MODELS_DIR")
    downloads_dir: str = Field(default=str(APP_DATA_DIR / "downloads"), alias="DOWNLOADS_DIR")
    metadata_file: str = Field(default=str(APP_DATA_DIR / "models.json"), alias="METADATA_FILE")
