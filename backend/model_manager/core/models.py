...
class ModelInfoDetailed(BaseModel):
    ...
    model_card: Optional[Dict[str, Any]] = Field(None, description="Model card metadata")
...
class GGUFProvider(BaseModel):
    ...
    is_recommended: bool = Field(False, description="Whether this provider is recommended")
...
class DownloadStatus(BaseModel):
    ...
    download_speed_mbps: Optional[float] = Field(None, description="Current download speed")
...
class ImportRequest(BaseModel):
    ...
    action: ImportAction = Field(ImportAction.COPY, description="Whether to copy or move file")

class LocalModel(BaseModel):
    """Information about locally stored model"""
    model_id: str = Field(..., description="Unique local model identifier")
    original_repo_id: Optional[str] = Field(None, description="Original HF repository ID")
    ...
    is_downloaded: bool = Field(True, description="Whether file was downloaded by Dennet")
